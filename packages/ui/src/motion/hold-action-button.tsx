    ...
    >
      ...
      >
        <motion.span
          ...
          className={cn(
            "absolute inset-0 bg-muted-foreground will-change-[opacity,transform]",
            fillClassName,
          )}
        >
          {!reduce ? (
            type === "horizontal" ? (
              <motion.svg
                ...
                className="absolute -right-5 top-0 h-[200%] w-6 text-muted-foreground"
              >
                <path
              ...
              <motion.svg
                ...
                className="absolute -top-5 left-0 h-6 w-[200%] text-muted-foreground"
              >
                <path
