    ...
    <>
      ...
      <thead>
        <tr style={{ height: rowHeight }}>
          {selectable ? (
            <th className="sticky top-0 z-10 border-b border-border bg-muted">
          ...
          {columns.map((column, index) => {
            ...
            return (
              <th
                ...
                className={cn(
                  "group sticky top-0 z-10 border-b border-border bg-muted p-0 font-medium text-muted-foreground",
                ...
                >
                  ...
                  {column.sortable ? (
                    <button
                      ...
                      className={cn(
                        "flex h-full min-w-0 flex-1 items-center gap-1 px-4 transition-colors select-none hover:text-foreground",
                    ...
                    <input
                      ...
                      className={cn(
                        "min-w-0 flex-1 appearance-none truncate rounded-md border-0 bg-transparent px-4 font-medium text-muted-foreground transition-colors outline-none focus:bg-muted focus:text-foreground",
          ...
          <th aria-hidden className="sticky top-0 z-10 border-b border-border bg-muted" />
        </tr>
      </thead>
    </>
  );
